...
for(taxa in taxaLevels){
    ...
    inFileName <- paste( taxa, "_LogNormwithMetadata_Merged.txt", sep ="")
    ...
    pdf( paste(taxa, filePrefix, "boxplots_Merged.pdf", sep=""))
    ...
    write.table(dFrame, file=paste("pValues", filePrefix, taxa, "_Merged.txt",sep=""), sep="\t",row.names=FALSE)
    ...
    write.table(sigdFrame, file=paste("SIGpValues", filePrefix, taxa, "_Merged.txt",sep=""), sep="\t",row.names=FALSE)
