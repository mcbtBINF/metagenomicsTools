...
for(taxa in taxaLevels){
    ...
    inFileName <- paste( taxa, "_LogNormwithMetadata_R2.txt", sep ="")
    ...
    pdf( paste(taxa, filePrefix, "boxplots_R2.pdf", sep=""))
    ...
    write.table(dFrame, file=paste("pValues", filePrefix, taxa, "_R2.txt",sep=""), sep="\t",row.names=FALSE)
    ...
    write.table(sigdFrame, file=paste("SIGpValues", filePrefix, taxa, "_R2.txt",sep=""), sep="\t",row.names=FALSE)
