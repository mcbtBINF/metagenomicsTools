...
for(t in taxaLevels )
{
	pdf(paste(t,"_weekly_PatientEnergyContent_ABSOLUTE_plots.pdf", sep="") )
...
#                        dev.off()
	...
	write.table(dFramemyLm, file= paste( "pValuesLongitudinalModelWeekly_PatientEnergyContent_ABSOLUTE_", t, ".txt", sep=""), row.names=FALSE, sep="\t")
