...
## Outlaying the possible problems:
## "r1_37" "r1_45" "r1_52" "r1_58" "r1_7"  "r1_9"
## Explanation for safety: 37 (NA dropped), 45 (NA dropped), 52 (NA dropped), 58 (NA dropped)
## 7 (NA dropped), 9 (NA dropped)

#t <- "family"
for(t in taxaLevels )
{
	pdf(paste(t,"_weekly_Patient_EnergyContent_plots.pdf", sep="") )
