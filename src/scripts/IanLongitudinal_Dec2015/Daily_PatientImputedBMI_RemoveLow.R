...
{
                                        #t<-taxaLevels[[1]]
        pdf( paste(t, "_ImputedBMIPatient_NoLow_plots.pdf", sep = ""))
...
par(mar = c(5, 4, 6, 2))
        ...
        write.table(dFrameDayPatient, file = paste("pValuesLongPatient_ImputedBMI_NoLow_", t, ".txt", sep=""), row.names=FALSE, sep="\t")
